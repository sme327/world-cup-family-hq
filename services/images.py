...
def get_country_image_data_uri(country: str) -> str | None:
    """Return a CSS-ready data: URI for a country image (for background-image)."""
...
def get_country_card_image(country_slug: str, item_slug: str) -> tuple[str, str] | None:
    """Return (base64_data, mime_type) for a country card image, or None if unavailable.

    Images live at: data/country_card_images/{country_slug}/{item_slug}.jpg
    Generated by scripts/download_country_card_images.py
    """
    rel = f"data/country_card_images/{country_slug}/{item_slug}.jpg"
    return _read_b64(os.path.join(_APP_ROOT, rel))
