...
with _tabs[1]:
    ...
    _legends = [
        ...
        {"emoji":"🎭","name":"Ronaldinho","flag":"🇧🇷","country":"Brazil","years":"2002–2006",
         ...
         "color":"#009C3B","image_url":None,"youtube_url":None},
        {"emoji":"👑","name":"Marta","flag":"🇧🇷","country":"Brazil","years":"2003–2019",
         "cups":"🥈🥈","wow":"All-time top scorer in Women's World Cup history — 17 goals across 5 tournaments",
         "story":"The greatest women's player of all time. She's won FIFA Player of the Year 6 times. In every World Cup, she found a way to do something nobody else could do. She once scored a bicycle kick goal that replays on highlight shows to this day.",
         "color":"#009C3B","image_url":None,"youtube_url":None},
        ...
        {"emoji":"⚽","name":"Mia Hamm","flag":"🇺🇸","country":"USA","years":"1991–2004",
         "cups":"🏆🏆","wow":"The woman who put women's soccer on the map for an entire generation",
         "story":"Mia Hamm was the face of American soccer for a decade — not just women's soccer, but all soccer. She won two Women's World Cups and two Olympic golds. When she played, little girls across America put on cleats and started playing. She changed everything.",
         "color":"#3B82F6","image_url":None,"youtube_url":None},
        {"emoji":"🔥","name":"Abby Wambach","flag":"🇺🇸","country":"USA","years":"2003–2015",
         "cups":"🏆","wow":"Most international goals in history — 184 goals — for 14 years",
         "story":"Abby Wambach is one of the most fearless competitors in sports history. She held the world record for international goals (men or women) for years. Her iconic header goal against Brazil in the 2011 Women's World Cup quarterfinal — in the 122nd minute — is one of the most dramatic goals ever scored.",
         "color":"#3B82F6","image_url":None,"youtube_url":"https://www.youtube.com/results?search_query=Abby+Wambach+header+Brazil+2011"},
    ]
...
with _tabs[5]:
    ...
    _milestones = [
        ...
        ("1991","👑","Women's World Cup begins","The first FIFA Women's World Cup was held in China. The USA won. Mia Hamm, Marta, and others became global icons."),
